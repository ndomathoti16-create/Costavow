...
export containing both fields, Costavow automatically proposes `EffectiveCost` because FOCUS
...
cash-basis budgeting, invoice alignment, or payable reconciliation. Costavow never combines the
